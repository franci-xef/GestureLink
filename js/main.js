...
const i18n = {
  it: {
    ...
    dl_version:     'Versione — v1.0 Beta',
    dl_sub:         'La versione Beta di GestureLink è ora disponibile. Provala ora!',
    dl_placeholder: 'Download per Windows',
    ...
    bom_5_p: 'Alimentatore 6 V / 10 A', bom_5_n: 'Separato da Arduino — i servo assorbono molto',
  ...
  en: {
    ...
    dl_version:     'Version — v1.0 Beta',
    dl_sub:         'The GestureLink Beta version is now available. Give it a try!',
    dl_placeholder: 'Download for Windows',
    ...
    bom_5_p: '6 V / 10 A power supply', bom_5_n: 'Separate from Arduino — servos draw a lot',
